    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl max-w-sm w-full overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="p-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2 text-center tracking-tighter">
            Campus Login
          </h2>
          ...
          >
            ...
            {error && (
              ...
              <p className="text-red-500 text-[10px] font-bold uppercase tracking-tighter ml-1 italic">
                {error}
              </p>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-indigo-600 text-white rounded-xl font-bold text-sm hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-900/20 disabled:opacity-50"
            >
